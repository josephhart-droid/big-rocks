...
export default function App() {
  ...
  const exportToPNG = async () => {
    try {
      ...
      alert('Export failed. Try zooming out or use your browser\'s screenshot tool.');
    }
  };
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Top black separator - outside export */}
        <div style={{
        ...
        <div id="export-area" style={{
          ...
          margin: '0 auto',
          padding: '0 24px',
          overflow: 'hidden', // helps with clean capture
        }}>
          {/* Product Name */}
        ...
        {/* Bottom black separator - outside export */}
        <div style={{
          borderTop: '2px solid #1A1A1A',
          margin: '48px 24px 0',
        }} />

        {/* DONE Section - outside export */}
        {columns.done && (
...
// ============================================================================
// Rock component (keep your current version here - no changes needed)
// ============================================================================

// ... paste your Rock function here (the one with className="rock", inline cursor/userSelect, etc.)

// ============================================================================
// RockEditModal component (keep your current version)
// ============================================================================

// ... paste your RockEditModal function here (the one with tag × buttons and onDeleteCustomTag call)
